...
def game_function(rounds_input):
    ...
    print("you have the following options:\n"
          ...
          "2/ Paper\n"
          "3/ Scissor\n")
    print("you can type in the number associated with the choice or the name of it as well.\n")
    ...
    while counting_rounds > 0:
        ...
        if user_choice.isdigit() or user_choice.isalpha():
            if user_choice.lower() in choice_list:
                ...
                # winning conditions
                # 1: rock condition
                if user_choice.lower() == "rock" or user_choice.lower() == "1":
                    if user_choice.lower() == computer_choice:
                        print("this is a DRAW\n"
                              "you both chose ROCK!\n"
                              f"{counting_rounds} rounds have lef.\n")
                    elif user_choice.lower() != computer_choice and (computer_choice == "2" or computer_choice == "paper"):
                        computer_wins += 1
                        counting_rounds -= 1
                        print("this is computer's WIN\n"
                              "you chose ROCK but computer chose PAPER!\n"
                              f"{counting_rounds} rounds have lef.\n")
                    elif user_choice.lower() != computer_choice and (computer_choice == "3" or computer_choice == "scissor"):
                        user_wins += 1
                        counting_rounds -= 1
                ...
                # 2: paper condition
                if user_choice.lower() == "paper" or user_choice.lower() == "2":
                    if user_choice.lower() == computer_choice:
                        print("this is a DRAW\n"
                        ...
                        print("this is computer's WIN\n"
                              ...
                              f"{counting_rounds} rounds have lef.\n")
                    elif user_choice.lower() != computer_choice and (computer_choice == "1" or computer_choice == "rock"):
                        user_wins += 1
                        counting_rounds -= 1
                        print("this is your WIN\n"
                ...
                # 3: scissor condition
                if user_choice.lower() == "scissor" or user_choice.lower() == "3":
                    if user_choice.lower() == computer_choice:
                        print("this is a DRAW\n"
